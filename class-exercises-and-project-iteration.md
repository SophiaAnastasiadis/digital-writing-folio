# Discussion and reflection: AI and Ethics
...
Personally, I believe that AI should be used as an assistive tool, not as the basis for a project (i.e., AI should not be used for ideation or brainstorming, or to write a creative piece). However, AI can be used to:
1. Assist with coding
2. Create and organise lists
...
# PROJECT ITERATION BRAINSTORMING DOC: LINK TO GOOGLE SLIDES
...
2. Edit my critical reflection (21/05/26)
3. Proofread all process documentation and add dates if necessary (23/05/2026)
4. Ensure all links are working (23/05/2026)
5. Complete a reference list for my critical reflection (23/05/2026)
6. Submit my critical reflection (25/05/2026)
